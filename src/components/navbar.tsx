...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav className="w-full px-4 sm:px-6 md:px-10 lg:px-28 py-3 sm:py-4 lg:py-5 bg-white border-b border-slate-200 flex justify-between items-center">
        {/* Logo Section */}
        <div className="flex items-center gap-2 cursor-pointer max-w-[200px] sm:max-w-[240px] md:max-w-[280px]">
          <img
            src={SensecureLogo}
            alt="Logo"
        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-5 lg:gap-6">
          <button className="px-3 sm:px-4 md:px-6 lg:px-7 py-1.5 sm:py-2 md:py-2.5 lg:py-3 rounded-lg border border-gray-800 text-gray-800 text-xs sm:text-sm md:text-base lg:text-lg font-medium font-['Nunito Sans'] hover:bg-gray-100 transition">
            Login
          </button>
          <button
            onClick={() => setIsContactOpen(true)}
            className="px-3 sm:px-4 md:px-6 lg:px-7 py-1.5 sm:py-2 md:py-2.5 lg:py-3 bg-gray-800 rounded-lg text-white text-xs sm:text-sm md:text-base lg:text-lg font-semibold font-['Nunito Sans'] hover:bg-gray-700 transition"
          >
            Contact Us
          </button>
        </div>
