...
const CTASection: React.FC = () => {
  return (
    <section className="w-full bg-slate-50 px-4 sm:px-6 lg:px-24 py-12 sm:py-16 lg:py-20 flex flex-col items-center text-center gap-5 sm:gap-6">
      {/* Border Wrapper */}
      <div
        className="w-full max-w-4xl border border-gray-200 rounded-xl 
        p-5 sm:p-8 lg:p-10 shadow-sm flex flex-col items-center text-center"
        style={{
      ...
      >
        {/* Headline */}
        <h2 className="text-gray-800 text-xl sm:text-3xl lg:text-4xl font-bold font-['Nunito Sans'] leading-snug sm:leading-normal tracking-tight">
          Ready to Secure Your Documents <br className="hidden sm:block" /> with{" "}
          <span className="text-slate-500">Sensecure?</span>
        </h2>

        {/* Description */}
        <p className="text-zinc-600 text-sm sm:text-lg lg:text-xl max-w-2xl mx-auto mt-3 sm:mt-5 font-normal font-['Nunito Sans'] leading-relaxed tracking-tight">
          Discover how Sensecure can transform your organization’s file sharing
          and document management. <br className="hidden sm:block" /> Our team is
        ...
        <div className="mt-6 sm:mt-8">
          <button
            ...
            text-sm sm:text-lg lg:text-xl font-semibold font-['Nunito Sans'] 
